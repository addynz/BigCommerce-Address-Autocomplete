...
function initAddyBigCommerce(){var e,t=[],d=[{idFields:["#CheckoutStepBillingAddress","#CreateAccountForm","#AddressEditForm"],countryField:"FormField_11",countryValue:"New Zealand",fields:{address1:"FormField_8",suburb:"FormField_9",city:"FormField_10",region:"FormField_12",postcode:"FormField_13"}},{idFields:["#CheckoutStepShippingAddress"],countryField:"FormField_21",countryValue:"New Zealand",fields:{address1:"FormField_18",suburb:"FormField_19",city:"FormField_20",region:"FormField_22",postcode:"FormField_23"}},{idFields:["#CheckoutStepShippingAddress"],countryField:"FormField_23",countryValue:"New Zealand",fields:{address1:"FormField_20",suburb:"FormField_21",city:"FormField_22",region:"FormField_24",postcode:"FormField_25"}},{idFields:["#micro-app-ng-checkout"],countryField:"countryCodeInput",countryValue:"string:NZ",fields:{address1:"addressLine1Input",suburb:"addressLine2Input",city:"cityInput",region:"provinceInput",postcode:"postCodeInput"}},{idFields:["form[data-create-account-form]","form[data-address-form]"],countryField:"FormField_11_select",countryValue:"New Zealand",fields:{address1:"FormField_8_input",suburb:"FormField_9_input",city:"FormField_10_input",region:"FormField_12_input",postcode:"FormField_13_input"}}];function i(e){var t;(t=e).target.className&&"nc_list"===t.target.className||t.relatedNode&&t.relatedNode.className&&"nc_list"===t.relatedNode.className||o()}function o(){this.observeTimeout&&clearTimeout(this.observeTimeout),this.observeTimeout=setTimeout(r,600)}function r(){for(var e=0;e<d.length;e++)for(var t=d[e],i=0;i<t.idFields.length;i++){var o=t.idFields[i],r=o+e,c=document.getElementById(t.countryField),a=(g=o,null!==document.querySelector(g)),m=n(c,t.countryValue),F=a&&(m||(p=c,y=t.countryValue,p&&p.value===y)),f=s(r,t.fields.address1);m&&f?(l(f),u(r,t.fields)):a&&F&&!f?u(r,t.fields):a&&F||!f||l(f)}var p,y,g}function n(e,t){if(!e||""!==e.value||!e.options)return!1;for(var d=0;d<e.options.length;d++)if(e.options[d].value===t)return e.value=t,a(e),!0;return!1}function s(e,d){for(var i=0;i<t.length;i++)if(e===t[i].controlId&&t[i].fields.address1.id===d)return t[i]}function l(e){e.widget.disable(),e.widget.destroy();var d=t.indexOf(e);d>-1&&t.splice(d,1)}function u(e,d){var i=document.getElementById(d.address1);if(i){var o=new AddyComplete(i);o.fields={address1:i,suburb:document.getElementById(d.suburb),city:document.getElementById(d.city),region:document.getElementById(d.region),postcode:document.getElementById(d.postcode)},o.addressSelected=c,o.controlId=e,t.push(o)}}function c(e){a(this.fields.address1),a(this.fields.suburb),a(this.fields.city),a(this.fields.region),a(this.fields.postcode)}function a(e){if(e){var t=document.createEvent("HTMLEvents");t.initEvent("change",!0,!1),e.dispatchEvent(t)}}(e=document.createElement("link")).setAttribute("rel","stylesheet"),e.setAttribute("type","text/css"),e.setAttribute("href","https://cdn.addy.co.nz/neatcomplete/2.1.0/addycomplete.min.css"),document.getElementsByTagName("head")[0].appendChild(e),r(),function(){window.MutationObserver?new MutationObserver(function(e){(function(e){for(var t=0;t<e.length;t++){var d=e[t];if(d.addedNodes)for(var i=0;i<d.addedNodes.length;i++)if("nc_list"===d.addedNodes[i].className)return!0}return!1})(e)||o()}.bind(this)).observe(document.body,{childList:!0,subtree:!0}):window.addEventListener&&(document.body.addEventListener("DOMNodeRemoved",i.bind(this),!1),document.body.addEventListener("DOMNodeInserted",i.bind(this),!1))}()}initAddyBigCommerce();